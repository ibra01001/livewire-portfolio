        ...
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="degree" wire:model="degree" placeholder="e.g. B.Sc. Computer Science"
            ...
            <div>
                <label for="description"
                    class="block text-sm font-bold text-[#1A1A1A] mb-2 uppercase tracking-wide">Description
                    (Optional)</label>
