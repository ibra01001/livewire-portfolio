    ...
    <div class="bg-white border-2 border-[#1A1A1A] rounded-lg shadow-[4px_4px_0px_0px_#1A1A1A] p-8 max-w-2xl mx-auto">
        <form wire:submit="save" class="space-y-8">
            ...
            <div>
                    ...
                    <div class="space-y-1 text-center">
                        @if ($image)
                            <div class="mx-auto h-20 w-20 relative">
                                <img src="{{ $image->temporaryUrl() }}" class="h-20 w-20 object-contain mx-auto"
                                    alt="Preview">
                ...
                @error('image') <span class="text-red-500 text-xs font-bold mt-1 block">{{ $message }}</span> @enderror
            </div>
            ...
            <div>
                ...
                <textarea id="description" wire:model="description" rows="3"
                    class="w-full px-4 py-3 bg-white border-2 border-[#1A1A1A] rounded-md focus:ring-0 focus:border-[#FF6B55] text-[#1A1A1A] placeholder-gray-400 transition-colors duration-200 outline-none resize-none shadow-sm"
                    placeholder="Short description of your experience with this skill..."></textarea>
